...
gmt psvelo temp.out -Se$scale/0.95/4 -G$Rcolor -W0.5p,$Rcolor -A0.2c+p1.2p+e -t20
awk -F, 'NR>1 && $9 ~ /IPGN/ {print $2,$3,$4,$5,$6,$7,$8}' $GPS > temp2.out
gmt psvelo temp2.out -Se$scale/0.95/4  -Gdarkred  -W0.5p,darkred -A0.2c+p1.2p+e  -t20
awk 'NR>1 {print $2,$3,$4,$5,$6,$7,$8}' $RGPS > temp3.out
gmt psvelo temp3.out -Se$scale/0.95/4  -Gblue -W0.5p,blue -A0.2c+p1.2p+e  -t20
